var quiz = [
  ...
  },
  {
    ...
    failed_message: "It's 6 times more than the size France, in other words 3,5 million square kilometers. And this is only the surface... If we were to take out of the water all the plastic that are being kept under the surface, its dimension would be able to cover the surface of all the oceans.",
    img:"./Tires.jpg"
  },
    {
    ...
    answer: 0,
    success_message: "That is right, the biggest plastic continent, also called the Great Pacific Garbage Patch, is located in the Pacific Ocean between Hawai and the Californian coast.",
  ...
  },
   {
    ...
    choices: ["50%", "80%", "100%"],
    answer: 1,
    success_message: "You are right! 80% of marine pollution originates from land. The rubbish that ends up in the sea are either carried by the wind, the rivers or carelessly thrown in by humans.",
    failed_message: "Right now, it's 80% of marine poullution that originates from land. The rubbish that ends up in the sea are either carried by the wind, the rivers or carelessly thrown in by humans.",
    img:"./Cleanup.jpg"
  },  
  {
    ...
    answer: 0,
    success_message: "That's correct, Boyan actually plans to launch its first mission in the coming months. He hopes to clean 50% of the Great Pacific Gargage Patch within 5 years.",
    failed_message: "The correct answer is to install floating traps to recover plastic in the ocean. Bryan hopes to clean 50% of the Great Pacific Gargage Patch within 5 years.",
    img:"./Slat.gif"
  },
  {
    ...
    answer: 2,
    success_message: "You are right. Around 5000 liters of water get contaminated by just one cigarette butt.",
