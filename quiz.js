var quiz = [
  {
    question: "What is the most common contaminant found in the ocean?",
    answer: "plastic",
  ...
  },
  {
    ...
    answer: 1,
    success_message: "The Ellen MacArthur Foundation reported at the World Economic Forum in 2016 that if business goes usual, the ocean will contain 1 tonnes of plastic for every 3 tonnes of fish by 2025 and more plastic than fish by 2050.",
  ...
  },
  {
    ...
    answer: 2,
    success_message:"Indeed, that represents 3,5 million square kilometers. But in reality this plastic continent is made of much plastic, most of it is caught underwater. If we were to take it out of the water it would cover the surface of all the oceans.",
    ...
    choices: ["", "", ""] ,
    success_message: "That is right, the biggest plastic continent also called the Great Pacific Garbage Patch is located in the pacific ocean between Hawai and the californian coast. Actually, the two images are real and show the other (smaller) plastic patch.",
  ...
  }
   {
    ...
    choices: ["50%", "80%", "100%"],
    answer: 1,
    success_message: "You are right! 80% of marine pollution originates from land and it is, carried by the wind, the rivers or carelessly thrown by humans, that it ends up in the sea.",
  ...
  },  
  {
    ...
    answer: ["Install floating traps to recover plastic in the ocean", "Commercialise a new kind of plastic that also serve as food for marine species", "Invent a liquid solution that will decompose plastic in safe bits"]
  ...
  {
    question: "What is the most commonly recovered item in the annual International Cleanup event?",
    answer: "cigarette butt",
    success_message: "That is right, cigarette butt were the most recovered item from the beaches",
    failed_message: "It's actually cigarette butt. They were the most recovered item from the beaches."
  },
    {
    question: "How much liter of water can one cigarette butt pollute if thrown into",
    answer: ["50 litres", "500 litres", "5000 liters"]
